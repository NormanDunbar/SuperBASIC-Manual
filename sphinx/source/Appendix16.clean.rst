...
Standard QL Colour Drivers MODE 4
^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
...
this does not correspond with the orignal QL colour scheme!). We have
tried to list the most widely used ones (INK 0 to INK 63 under
